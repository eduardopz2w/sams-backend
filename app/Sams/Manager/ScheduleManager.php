...
class ScheduleManager extends BaseManager {
  ...
  public function getMessages() {
    $messages = [
      'entry_time.required' => 'Ingrese hora de inicio',
      'entry_time.date_format' => 'Ingresa formato de hora de entrada valido',
      'departure_time.required' => 'Ingrese hora de fin',
      'departure_time.date_format' => 'Ingrese formato de hora de salida valido'
    ];

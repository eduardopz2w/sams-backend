...
class CitationController extends BaseController {
	 ...
	 public function __construct(CitationTask $citationTask, ElderRepository $elderRepo,
	 	                           ElderTask $elderTask, CitationRepository $citationRepo, ReferenceRepository $referenceRepo)
...

	 {
	 		 ...
	 		 $citations = $this->citationTask->confirmedCitationDate($citations);
...

	 {
	 		...
	 		$citations = $this->citationTask->confirmCitationHour();
